<%-- 
    ...
    Created on : 22/05/2011, 16:13:22
    Author     : jpossatti
--%>
    ...
    <body>
        <fieldset>
            <table border="0" align="center" width="100%">
                <tr>
                    <td style="background-color: #87CEFA;" align="center" colspan="3"><div id="titulo">Alteração de Departamentos</div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" bgcolor="#f9f9f9">
                        <form name="alterardepartamento" action="AlterarDepartamento" method="POST">
                            <table border="0" align="center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="nome_departamento" value="${departamento.nome_departamento}" size="60"/>
                                        <input type="hidden" name="id_departamento" value="${departamento.id_departamento}" size="60"/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <select name="id_cargo" multiple class="box">
                                                <%
                                                    List<Cargo> cargos = (List<Cargo>) request.getAttribute("cargo");
