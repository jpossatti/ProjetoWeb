    ...
    <body>
        <fieldset>
            <table border="0" align="center" width="100%">
                <tr>
                    <td style="background-color: #87CEFA;"align="center" colspan="3"><div id="titulo">Cadastro de Cargos</div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" bgcolor="#f9f9f9">
                        <form name="cadastrarcargo" action="CadastrarCargo" onsubmit="return ValidaCadastroCargo()" method="POST">
                            <table border="0" align="center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="nome_cargo" value="" size="60"/></td>
                                        <td></td>
                                    </tr>
                                    <tr>
