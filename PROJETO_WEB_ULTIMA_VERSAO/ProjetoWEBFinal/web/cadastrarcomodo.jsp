<%-- 
    Document   : cadastrarcomodo
    Created on : 11/05/2011, 14:54:24
    Author     : jpossatti
--%>
<%
...
<html>
    <head>
        ...
        <title> Cadastro de Comodo </title>
    </head>
    <body>
        <fieldset>
            <table border="0" align="center" width="100%">
                <tr>
                    <td style="background-color: #87CEFA;"align="center" colspan="3"><div id="titulo">Cadastro de Comodos</div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" bgcolor="#f9f9f9">
                        <form name="cadastrarcomodo" action="CadastrarComodo" method="POST" onsubmit="return ValidaCadastroComodo()">
                            <table border="0" align="center">
                                ...
                                <tbody><tr>
                                        ...
                                        <td><input type="text" name="nome_comodo" value="" size="60" /></td>
                                        <td></td>
                                    <tr>
