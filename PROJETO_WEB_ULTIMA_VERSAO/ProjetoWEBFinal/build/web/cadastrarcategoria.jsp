<%-- 
    ...
    Created on : 13/05/2011, 09:54:38
    Author     : jpossatti
--%>
<%
    if(
        request.getSession().getAttribute("administrador") != null || 
    ...
    <body>
        <fieldset>
            <table border="0" align="center" width="100%">
                <tr>
                    <td style="background-color: #87CEFA;"align="center" colspan="3"><div id="titulo">Cadastro de Categoria</div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" bgcolor="#f9f9f9">
                        <form name="cadastrarcategoria" action="CadastrarCategoria" method="POST" onsubmit="return ValidaCadastroCategoria()">
                            <table border="0" align="center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="descricao_categoria" value="" size="60"/></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td id="textcadastro">Grupo Contábil </td>
                                        <td><input type="text" name="grupo_categoria" value="" maxlength="5" size="5"/></td>
                                        <td></td>
                                    </tr>
                                    <tr>
