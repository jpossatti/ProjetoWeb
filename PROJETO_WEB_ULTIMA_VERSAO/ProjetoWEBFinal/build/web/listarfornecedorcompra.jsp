...
<html>
    ...
    <body>
        ...
        <table border="0" align="center" cellspacing="0" cellpadding="9" class="borda">
            <tbody>
                <tr id="texttitlelist" style="cursor:default" onMouseOver="javascript:this.style.backgroundColor='#E8E8E8'" onMouseOut="javascript:this.style.backgroundColor=''">
                    <td><b>Nome</b></td>
                ...
                %>
            <form action="AdicionarFornecedorCompra" method="POST">
                <tr id="textcorplist">
                    <td><input type="hidden" name="id_fornecedor" value="<%=fornecedor.getId_fornecedor()%>" size="40" readonly="readonly" />
                        <%=fornecedor.getNome_pessoa()%>
                        <input type="hidden" name="nome_fornecedor" value="<%=fornecedor.getNome_pessoa()%>" size="40" readonly="readonly" /></td>
