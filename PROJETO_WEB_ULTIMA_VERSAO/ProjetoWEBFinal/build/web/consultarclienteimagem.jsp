        ...
        <table border="0" align="center" width="100%">
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td bgcolor="#f9f9f9">
                        <form name="consultarclienteimagem" action="ConsultarClienteImagem" method="POST">
                            <table border="0" align="center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="nome_cliente" value="" size="40"/></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td align="right" colspan="2">
                                            <input type="image" src="img/enviar.png" style="border-width: 0" value="Enviar" name="Enviar" align="right" onclick="retiraAcentos(this.form)"/>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
