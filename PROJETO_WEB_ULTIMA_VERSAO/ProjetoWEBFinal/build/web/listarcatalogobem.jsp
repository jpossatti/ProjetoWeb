        ...
        <table border="0" align="center" cellspacing="0" cellpadding="9" class="borda">
            <tbody>
                ...
                <%
                    ...
                    for (Bem bem : bens) {
                %>
            <form name="cadastrar" id="cadastrar" action="CarrinhoAdicionarBem" method="POST">
                <tr id="textcorplist" style="cursor:default" onMouseOver="javascript:this.style.backgroundColor='#E8E8E8'" onMouseOut="javascript:this.style.backgroundColor=''">
                    ...
                    <td>R$: <%=df.format(bem.getPrecomaodeobra_bem())%></td>
                    <td><input type="text" name="quantidade_pedido_compra" value="" size="5"/></td>
                    <td><select id="id_comodo" name="id_comodo">
                            <%
                    ...
                    <td><input type="submit" value="Adicionar" onclick="return verificaEstoque('quantidade_pedido='+documentlistarcatalogobem.quantidade_pedido_compra.value);"/></td>
                </tr>
            </form>
            <%}%>
        </tbody>
