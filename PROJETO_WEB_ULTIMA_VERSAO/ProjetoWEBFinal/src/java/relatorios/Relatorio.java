...
public class Relatorio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tipoPessoa = request.getParameter("tipo_pessoa").toUpperCase();
        ...
        try {
           ...
           //String sql = "SELECT * FROM administrativo.pessoa p WHERE p.tipo_pessoa = 'FISICA'";
        ...
        byte[] bytes = null;
        try {
            URL url = this.getClass().getClassLoader().getResource("/relatorios/relatoriopessoa.jasper");
