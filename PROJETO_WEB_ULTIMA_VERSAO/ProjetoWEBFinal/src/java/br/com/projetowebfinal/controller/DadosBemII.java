 ...
 * @author Anderson
 */
public class DadosBemII extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SubCategoriaDAO subcategoria = new SubCategoriaDAOImp();
            request.setAttribute("categorias", subcategoria.listar());//aki é listado os dados da categoria
            request.getRequestDispatcher("cadastrarbem.jsp").forward(request, response);
         } catch (Exception ex) {
