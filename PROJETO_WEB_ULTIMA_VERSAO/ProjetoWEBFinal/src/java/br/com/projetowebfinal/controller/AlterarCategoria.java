...
public class AlterarCategoria extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            String nome_categoria = request.getParameter("descricao_categoria").toUpperCase();
            
            Categoria categoria = new Categoria();
            categoria.setDescricao_categoria(nome_categoria);
            categoria.setId_categoria(id_categoria);
            categoria.setGrupo_categoria(grupo_categoria);

            String mensagem = categoria.getDescricao_categoria() + " Alterado com Sucesso";
            ...
            request.getRequestDispatcher("ListarCategoria")/*Quando for LISTAR usar o servlet no Dispacther*/.forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problema no servlet ao alterar categoria! Erro: " + ex.getMessage());
        }
    }
