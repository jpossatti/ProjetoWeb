 ...
 * @author jpossatti
 */
public class AlterarSubCategoria extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            Integer id_sub_categoria=Integer.parseInt(request.getParameter("id_sub_categoria"));
            ...
            Integer sequencia_subcategoria = Integer.parseInt(request.getParameter("sequencia_subcategoria"));

            SubCategoria subcategoria = new SubCategoria();

            subcategoria.setNome_sub_categoria(nome_sub_categoria);
            subcategoria.setId_sub_categoria(id_sub_categoria);
            subcategoria.setId_categoria(id_categoria);
            subcategoria.setSequencia_subcategoria(sequencia_subcategoria);

            String mensagem = subcategoria.getNome_sub_categoria() + " Alterado com Sucesso";

            SubCategoriaDAO dao = new SubCategoriaDAOImp();/*cria o metodo mas ele recebe o AlunoDAOImp*/
            dao.alterarSubCategoria(subcategoria);
            request.setAttribute("mensagem", mensagem);
            request.setAttribute("listagem", dao.listar());
            request.getRequestDispatcher("ListarSubCategoria")/*Quando for LISTAR usar o servlet no Dispacther*/.forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problema no servlet ao alterar sub-categoria! Erro: " + ex.getMessage());
        }
    }
