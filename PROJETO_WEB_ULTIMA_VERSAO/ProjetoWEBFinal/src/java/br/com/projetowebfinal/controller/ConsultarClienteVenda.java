...
public class ConsultarClienteVenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nome_cliente = request.getParameter("nome_cliente").toUpperCase();
        try {
            ClienteDAO dao = new ClienteDAOImp();
            request.setAttribute("listaclientes", dao.consultarCliente(nome_cliente));
            request.getRequestDispatcher("listarclientevenda.jsp").forward(request, response);
