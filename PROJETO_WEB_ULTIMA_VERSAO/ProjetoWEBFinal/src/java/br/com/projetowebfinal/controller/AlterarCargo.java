...
public class AlterarCargo extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            Integer id_cargo = Integer.parseInt(request.getParameter("id_cargo"));
            ...
            String mensagem = cargo.getNome_cargo() + " Alterado com Sucesso";
            ...
            request.getRequestDispatcher("ListarCargo")/*Quando for LISTAR usar o servlet no Dispacther*/.forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problema no servlet ao alterar cargo! Erro: " + ex.getMessage());
        }
    }
