...
public class ExcluirComodo extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            dao.excluirComodo(id_comodo);
            request.getRequestDispatcher("ListarComodo").forward(request, response);

        }catch (Exception ex){
            System.out.println("Problemas no Servlet as excluir comodo !Erro:"+ex.getMessage());
            ex.printStackTrace();
        }
    }
