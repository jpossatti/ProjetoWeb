 ...
 * @author Anderson
 */
public class BuscarProdutoBem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("listaproduto", dao.consultarProdutoBem(descricao_produto));
            request.getRequestDispatcher("listarprodutobem.jsp").forward(request, response);
