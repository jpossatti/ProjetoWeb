 ...
 * @author jpossatti
 */
public class ListarSubCategoria extends HttpServlet {
    ...
    throws ServletException, IOException {
         try{
            ...
            request.getRequestDispatcher("listarsubcategoria.jsp").forward(request, response);
        }catch (Exception ex){
            System.out.println("Problemas no Servlet ao listar sub-categoria!Erro:"+ex.getMessage());
            ex.printStackTrace();
