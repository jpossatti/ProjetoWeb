 ...
 * @author Anderson
 */
public class ListarImovelClienteVenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("imoveis", dao.consultarImovel(idCliente));
            request.getRequestDispatcher("listarimovelclientevenda.jsp").forward(request, response);
        }catch (Exception ex){
