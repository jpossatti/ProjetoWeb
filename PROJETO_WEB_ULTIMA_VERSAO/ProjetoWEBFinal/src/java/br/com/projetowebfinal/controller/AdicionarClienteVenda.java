...
public class AdicionarClienteVenda extends HttpServlet {
    ...
    try{
        ...
        sessao.setAttribute("id_cliente", request.getParameter("id_cliente"));
        sessao.setAttribute("nome_cliente", request.getParameter("nome_cliente"));
        request.getRequestDispatcher("ListarImovelClienteVenda").forward(request, response);
