 ...
 * @author jpossatti
 */
public class CarregarImovel extends HttpServlet {
    ...
    throws ServletException, IOException {
       int id_imovel = Integer.parseInt(request.getParameter("id_imovel"));
        try{
            ...
            request.setAttribute("imovel", dao.listarImovel(id_imovel));
            request.setAttribute("clientes", daoc.listar());
            request.getRequestDispatcher("alterarimovel.jsp").forward(request, response);
        } catch(Exception ex){
            System.out.println("problemas no servlet ao carregar imovel!:"+ex.getMessage());
            ex.printStackTrace();
